...
router.route('/getFollowerList').post(controller.getFollowerList);
router.route('/getOpenChatRoomList/:type').get(controller.getOpenChatRoomList);

router.route('/addFriend').post( controller.addFriend);
router.route('/deleteFriend').post( controller.deleteFriend);
router.route('/getUserByNo/:userNo').get( controller.getUserByNo);
router.route('/updateSettings').post(upload.single( "file"),  controller.updateSettings);
router.route('/deleteUserInfo').post( controller.deleteUserInfo);
...
// layer 변경
router.route('/joinRoom').post(controller.joinRoom);
